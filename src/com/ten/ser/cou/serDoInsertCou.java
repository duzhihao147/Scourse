...
// Source File Name:   serDoInsertCou.java
...
public class serDoInsertCou extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(rs != 0)
                out.println((new StringBuilder("\u6DFB\u52A0\u6210\u529F\uFF1A")).append(cou.getCNo()).toString());
            else
                out.println((new StringBuilder("\u6DFB\u52A0\u5931\u8D25")).append(cou.getCNo()).toString());
